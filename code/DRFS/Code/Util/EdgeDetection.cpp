...
void edgeDetection(cv::Mat& src, cv::Mat& dst, double threshold)
{
	...
	string modelCfg = R"(C:\Users\grey\Desktop\ESP\GES-GSP-Stitching-master\Code\model\deploy.prototxt)";
	string modelBin = R"(C:\Users\grey\Desktop\ESP\GES-GSP-Stitching-master\Code\model\hed_pretrained_bsds.caffemodel)";
